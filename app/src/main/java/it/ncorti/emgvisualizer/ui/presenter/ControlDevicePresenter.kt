...
class ControlDevicePresenter @Inject constructor(private val view: ControlDeviceContract.View, private val myonnaise: Myonnaise, private val deviceManager: DeviceManager) :
    ControlDeviceContract.Presenter {
    ...
    override fun onStreamingToggleClicked() {
        deviceManager.myo?.apply {
            if (!this.isStreaming()) {
                this.sendCommand(CommandList.emgPlusFiltered()) // CommandList.emgFilteredOnly()
            } else {
